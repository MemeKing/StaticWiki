...
Other media formats such as audio and video can also be embedded using the <audio> or <video> tags. However you must whitelist the appropriate file extensions in staticwiki.ini for these files to be copied to the output folder.
